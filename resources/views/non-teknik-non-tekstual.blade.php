...
@endif
        ...
        <div class="overflow-x-auto hide-bulk" id="tableContainerBulkPa">
            @php
                $headers = ['<input type="checkbox" id="selectAllBulkPa" class="bulk-cb-header" onclick="toggleSelectAllPa()">', 'Tahun', 'Bulan'];
