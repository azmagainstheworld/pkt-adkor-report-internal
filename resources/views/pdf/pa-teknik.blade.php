...
<body>
    ...
    <!-- TABEL 2 -->
    <div class="section-title">2. Rincian Dokumen Ekstra (Tabel 2)</div>
    <table>
        <thead>
            <tr>
                <th style="width: 40px;">Tahun</th>
