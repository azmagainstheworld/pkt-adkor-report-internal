...
// Find position of 'public function import(' and slice it
$pos = strpos($content, 'public function import(Request $request)');
if ($pos !== false) {
    $content = substr($content, 0, $pos) . $missingMethods . "\n}\n";
    file_put_contents($controllerPath, $content);
    echo "Patched successfully.\n";
} else {
    echo "Could not find import method.\n";
}
