...
<?php endif; ?>
    ...
    <div class="flex justify-between items-end mb-6">
        <div>
            ...
            <p class="text-sm text-gray-500 font-medium"><?php echo e(\Carbon\Carbon::now()->format('l, d F Y')); ?></p>
        </div>
        
        <!-- Filter Kanan Atas Dinamis -->
        <form action="<?php echo e(route('undangan.index')); ?>" method="GET" class="flex items-center gap-3">
            <select name="tahun" onchange="this.form.submit()" class="px-4 py-2 border border-gray-200 rounded-xl bg-white text-sm text-gray-700 shadow-sm cursor-pointer outline-none focus:border-blue-500">
                ...
                <?php $__currentLoopData = $tahunTersedia; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $thn): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($thn); ?>" <?php echo e($tahunFilter == $thn ? 'selected' : ''); ?>><?php echo e($thn); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.card','data' => ['class' => '!rounded-xl overflow-visible shadow-sm border border-gray-100 mb-8 p-6 bg-white']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => '!rounded-xl overflow-visible shadow-sm border border-gray-100 mb-8 p-6 bg-white']); ?>
        <div class="mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
                ...
                <p class="text-xs text-gray-400">
                    ...
                    <?php echo e($tahunFilter == 'semua' ? 'Keseluruhan (Semua Tahun)' : 'Tahun ' . $tahunFilter); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.button','data' => ['variant' => 'outline','type' => 'button','onclick' => 'toggleActionDropdown(\'dropdownUndangan\')','class' => '!rounded-xl !py-2 shadow-sm text-xs font-medium text-blue-600 border-blue-200 hover:bg-blue-50 flex items-center gap-1.5 min-w-[140px] justify-center']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'outline','type' => 'button','onclick' => 'toggleActionDropdown(\'dropdownUndangan\')','class' => '!rounded-xl !py-2 shadow-sm text-xs font-medium text-blue-600 border-blue-200 hover:bg-blue-50 flex items-center gap-1.5 min-w-[140px] justify-center']); ?>
...
<?php endif; ?>
                    ...
                    <div id="dropdownUndangan" class="hidden absolute right-0 mt-2 w-64 bg-white rounded-xl shadow-xl border border-gray-100 z-50 py-2 origin-top-right transition-all duration-200">
                        ...
                        <a href="<?php echo e(route('undangan.export.excel', request()->query())); ?>" class="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-50 transition-colors">
                        ...
                        <a href="<?php echo e(route('undangan.export.pdf', request()->query())); ?>" class="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-50 transition-colors">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.table','data' => ['headers' => $headers]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes(['headers' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($headers)]); ?>
                <?php $__empty_1 = true; $__currentLoopData = $tableData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php $tambahan = is_string($row->data_tambahan) ? json_decode($row->data_tambahan, true) : ($row->data_tambahan ?? []); ?>
                    <tr class="hover:bg-gray-50 transition-colors text-sm border-b border-gray-100 last:border-0">
                        <td class="px-6 py-4 text-center"><input type="checkbox" name="ids[]" class="cb-detail" value="<?php echo e($detail->id); ?>" onclick="toggleCheckbox('detail')"></td>
                        <td class="px-6 py-4 text-gray-700 font-medium whitespace-nowrap"><?php echo e($row->tahun); ?></td>
                        <td class="px-6 py-4 text-gray-900 font-medium whitespace-nowrap"><?php echo e($row->bulan); ?></td>
                        <td class="px-6 py-4 text-gray-700 font-semibold"><?php echo e($row->undangan_intern); ?> Berkas</td>
                        <td class="px-6 py-4 text-gray-700 font-semibold"><?php echo e($row->undangan_ekstern); ?> Berkas</td>
                            ...
                            <?php $__currentLoopData = $kolomDinamis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kolom): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <td class="px-6 py-4 text-gray-600 font-medium align-middle">
                                    <?php if($kolom->tipe_input === 'currency' && isset($tambahan[$kolom->nama_kolom])): ?>
                                        Rp <?php echo e($tambahan[$kolom->nama_kolom]); ?>
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <tr><td colspan="<?php echo e(count($headers)); ?>" class="px-6 py-10 text-center text-gray-500">Tidak ada data untuk filter yang dipilih.</td></tr>
                <?php endif; ?>
                ...
                <tr class="bg-gray-100 font-bold text-gray-900 text-sm border-t border-gray-200">
                    ...
                    <td class="px-6 py-4 text-pkt-biru"><?php echo e($totalIntern); ?> Berkas</td>
                    <td class="px-6 py-4 text-pkt-biru"><?php echo e($totalEkstern); ?> Berkas</td>
                    <?php if(isset($kolomDinamis)): ?> <td colspan="<?php echo e(count($kolomDinamis) + 1); ?>"></td> <?php else: ?> <td></td> <?php endif; ?>
                </tr>
                <?php endif; ?>
             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<!-- ================= TABEL RINCIAN UNDANGAN (TABEL 2) ================= -->
    <?php if (isset($component)) { $__componentOriginal53747ceb358d30c0105769f8471417f6 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal53747ceb358d30c0105769f8471417f6 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.card','data' => ['class' => '!rounded-xl overflow-visible !p-0 shadow-sm border border-gray-100 bg-white mt-8 mb-8']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => '!rounded-xl overflow-visible !p-0 shadow-sm border border-gray-100 bg-white mt-8 mb-8']); ?>
        <div class="p-5 border-b border-gray-100 bg-white flex justify-between items-center">
            <div>
                ...
                <div class="relative dropdown-container">
                    <?php if (isset($component)) { $__componentOriginald0f1fd2689e4bb7060122a5b91fe8561 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald0f1fd2689e4bb7060122a5b91fe8561 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.button','data' => ['variant' => 'outline','type' => 'button','onclick' => 'toggleActionDropdown(\'dropdownUndanganDetail\')','class' => '!rounded-xl !py-2 shadow-sm text-xs font-medium text-blue-600 border-blue-200 hover:bg-blue-50 flex items-center gap-1.5 min-w-[140px] justify-center']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'outline','type' => 'button','onclick' => 'toggleActionDropdown(\'dropdownUndanganDetail\')','class' => '!rounded-xl !py-2 shadow-sm text-xs font-medium text-blue-600 border-blue-200 hover:bg-blue-50 flex items-center gap-1.5 min-w-[140px] justify-center']); ?>
                        <svg class="w-4 h-4 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4"></path></svg>
                        Opsi Lanjutan
                        <svg class="w-3 h-3 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
                     <?php echo $__env->renderComponent(); ?>
...
<?php endif; ?>
                ...
                <?php if (isset($component)) { $__componentOriginald0f1fd2689e4bb7060122a5b91fe8561 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald0f1fd2689e4bb7060122a5b91fe8561 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.button','data' => ['variant' => 'primary','onclick' => 'openModal(\'modalTambahDetail\')','class' => '!bg-[#F7941E] hover:!bg-orange-600 border-none !rounded-xl !py-2 shadow-sm text-xs']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'primary','onclick' => 'openModal(\'modalTambahDetail\')','class' => '!bg-[#F7941E] hover:!bg-orange-600 border-none !rounded-xl !py-2 shadow-sm text-xs']); ?>
...
<?php endif; ?>
                ...
                <form id="bulkDeleteDetailForm" action="<?php echo e(route('undangan.detail.destroyBulk')); ?>" method="POST" onsubmit="return confirm('Hapus data terpilih?')">
            <?php echo csrf_field(); ?>
            ...
            <?php if (isset($component)) { $__componentOriginal163c8ba6efb795223894d5ffef5034f5 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal163c8ba6efb795223894d5ffef5034f5 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.table','data' => ['headers' => $headersDetail]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('table'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['headers' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($headersDetail)]); ?>
                <?php $safeDetails = $detailsData ?? []; ?>
                <?php $__empty_1 = true; $__currentLoopData = $safeDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-gray-50 transition-colors text-sm border-b border-gray-100 last:border-0">
                        <td class="px-6 py-4 text-center"><input type="checkbox" name="ids[]" class="cb-detail" value="<?php echo e($detail->id); ?>" onclick="toggleCheckbox('detail')"></td>
                        <td class="px-6 py-4 text-gray-700 font-medium whitespace-nowrap"><?php echo e($index + 1); ?></td>
                        <td class="px-6 py-4 text-gray-700 font-medium whitespace-nowrap"><?php echo e($detail->tahun); ?></td>
                        <td class="px-6 py-4 text-gray-900 font-medium whitespace-nowrap"><?php echo e($detail->bulan); ?></td>
                        <td class="px-6 py-4 text-gray-700">
                            <?php if($detail->jenis_undangan == 'Internal'): ?>
                        ...
                        <td class="px-6 py-4 text-gray-700"><?php echo e($detail->agenda ?? '-'); ?></td>
                        
                        <td class="px-6 py-4 text-center">
                            <div class="flex gap-2 justify-center">
                                <button type="button" onclick="editDataDetail(<?php echo e(json_encode($detail)); ?>)" class="p-1.5 text-amber-500 hover:bg-amber-50 rounded-md border border-amber-200" title="Edit Data">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path></svg>
                                </button>
                                <form action="<?php echo e(route('undangan.detail.destroy', $detail->id)); ?>" method="POST" class="inline" onsubmit="return confirm('Yakin ingin menghapus rincian ini?');">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('DELETE'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modal','data' => ['id' => 'modalImportUndangan','title' => 'Import Data Undangan']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'modalImportUndangan','title' => 'Import Data Undangan']); ?>
        <form action="<?php echo e(route('undangan.import')); ?>" method="POST" enctype="multipart/form-data" id="formImportUndangan" class="space-y-4">
            <?php echo csrf_field(); ?>
            ...
            <div class="bg-blue-50 border border-blue-200 text-blue-700 p-4 rounded-xl text-sm mb-4">
                ...
                <div class="mt-3">
                    <a href="<?php echo e(route('undangan.download.template')); ?>" class="inline-flex items-center gap-1.5 text-blue-600 font-bold hover:text-blue-800 underline underline-offset-2">
            ...
            <div>
             ...
             <?php $__env->slot('footer', null, []); ?> 
                <?php if (isset($component)) { $__componentOriginald0f1fd2689e4bb7060122a5b91fe8561 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald0f1fd2689e4bb7060122a5b91fe8561 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.button','data' => ['variant' => 'outline','type' => 'button','onclick' => 'closeModal(\'modalImportUndangan\')','class' => '!px-6 !py-2.5 !rounded-lg']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'outline','type' => 'button','onclick' => 'closeModal(\'modalImportUndangan\')','class' => '!px-6 !py-2.5 !rounded-lg']); ?>Batal <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginald0f1fd2689e4bb7060122a5b91fe8561)): ?>
<?php $attributes = $__attributesOriginald0f1fd2689e4bb7060122a5b91fe8561; ?>
<?php unset($__attributesOriginald0f1fd2689e4bb7060122a5b91fe8561); ?>
...
<?php endif; ?>
                <?php if (isset($component)) { $__componentOriginald0f1fd2689e4bb7060122a5b91fe8561 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald0f1fd2689e4bb7060122a5b91fe8561 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.button','data' => ['variant' => 'primary','type' => 'submit','form' => 'formImportUndangan','class' => '!px-6 !py-2.5 !rounded-lg !bg-pkt-jingga hover:!bg-orange-600 border-none']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'primary','type' => 'submit','form' => 'formImportUndangan','class' => '!px-6 !py-2.5 !rounded-lg !bg-pkt-jingga hover:!bg-orange-600 border-none']); ?>Import Data <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginald0f1fd2689e4bb7060122a5b91fe8561)): ?>
<?php $attributes = $__attributesOriginald0f1fd2689e4bb7060122a5b91fe8561; ?>
<?php unset($__attributesOriginald0f1fd2689e4bb7060122a5b91fe8561); ?>
...
<?php if (isset($component)) { $__componentOriginal9f64f32e90b9102968f2bc548315018c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal9f64f32e90b9102968f2bc548315018c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modal','data' => ['id' => 'modalAturKolom','title' => 'Pengaturan Kolom Tambahan','description' => 'Kelola kolom ekstra khusus untuk modul Undangan.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('modal'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'modalAturKolom','title' => 'Pengaturan Kolom Tambahan','description' => 'Kelola kolom ekstra khusus untuk modul Undangan.']); ?>
        <div class="mb-6 bg-gray-50 p-4 rounded-xl border border-gray-100 max-h-48 overflow-y-auto">
            ...
            <?php if(isset($kolomDinamis) && $kolomDinamis->count() > 0): ?>
                <?php $__currentLoopData = $kolomDinamis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kolom): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="flex justify-between items-center bg-white p-3 rounded-lg border border-gray-200 mb-2 shadow-sm">
                        <div>
                            ...
                            <p class="text-[11px] text-gray-500">Tipe: <span class="uppercase font-bold text-gray-700"><?php echo e($kolom->tipe_input); ?></span> 
                                <?php if($kolom->tipe_input === 'dropdown' && $kolom->pilihan_dropdown): ?> | Opsi: <?php echo e(implode(', ', json_decode($kolom->pilihan_dropdown))); ?> <?php endif; ?>
                            </p>
                        </div>
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <?php else: ?> <p class="text-xs text-gray-500 italic">Belum ada kolom tambahan yang dibuat.</p> <?php endif; ?>
        </div>
        <form action="<?php echo e(route('kolom-dinamis.store')); ?>" method="POST" class="border-t pt-5 space-y-4">
            <?php echo csrf_field(); ?> <input type="hidden" name="modul" value="undangan">
...
<?php endif; ?>
    ...
    <?php if (isset($component)) { $__componentOriginal9f64f32e90b9102968f2bc548315018c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal9f64f32e90b9102968f2bc548315018c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modal','data' => ['id' => 'modalTambah','title' => 'Input Data Undangan','description' => 'Pilih periode dan masukkan total undangan untuk bulan tersebut. (Bersifat overwrite)']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('modal'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'modalTambah','title' => 'Input Data Undangan','description' => 'Pilih periode dan masukkan total undangan untuk bulan tersebut. (Bersifat overwrite)']); ?>
        <form action="<?php echo e(route('undangan.store')); ?>" method="POST" id="formTambah" class="space-y-5 novalidate-form" novalidate>
            <?php echo csrf_field(); ?>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <?php $__currentLoopData = $kolomDinamis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kolom): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="md:col-span-2">
                            <label class="block text-xs font-medium text-gray-700 mb-1"><?php echo e($kolom->nama_kolom); ?></label>
                            <?php if($kolom->tipe_input === 'text'): ?><input type="text" name="data_tambahan[<?php echo e($kolom->nama_kolom); ?>]" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm outline-none">
                            <?php elseif($kolom->tipe_input === 'number'): ?><input type="number" name="data_tambahan[<?php echo e($kolom->nama_kolom); ?>]" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm outline-none">
                            <?php elseif($kolom->tipe_input === 'currency'): ?>
                                <div class="relative"><div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-gray-500">Rp</div><input type="text" name="data_tambahan[<?php echo e($kolom->nama_kolom); ?>]" class="input-currency w-full pl-9 pr-4 py-2 border border-gray-300 rounded-lg text-sm font-mono outline-none" placeholder="0"><input type="hidden" name="data_tambahan[<?php echo e($kolom->nama_kolom); ?>]"></div>
                            <?php elseif($kolom->tipe_input === 'date'): ?><input type="date" name="data_tambahan[<?php echo e($kolom->nama_kolom); ?>]" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm outline-none">
                            <?php elseif($kolom->tipe_input === 'dropdown'): ?>
                                <select name="data_tambahan[<?php echo e($kolom->nama_kolom); ?>]" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm outline-none">
                                    <option value="">Pilih...</option>
                                    <?php if($kolom->pilihan_dropdown): ?> <?php $__currentLoopData = json_decode($kolom->pilihan_dropdown); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pilihan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><option value="<?php echo e(trim($pilihan)); ?>"><?php echo e(trim($pilihan)); ?></option><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> <?php endif; ?>
                                </select>
                            <?php endif; ?>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'primary','type' => 'submit','form' => 'formTambah','class' => '!px-6 !py-2.5 !rounded-lg !bg-pkt-jingga hover:!bg-orange-600 border-none']); ?>Simpan Data <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginald0f1fd2689e4bb7060122a5b91fe8561)): ?>
<?php $attributes = $__attributesOriginald0f1fd2689e4bb7060122a5b91fe8561; ?>
<?php unset($__attributesOriginald0f1fd2689e4bb7060122a5b91fe8561); ?>
...
<?php endif; ?>
    ...
    <?php if (isset($component)) { $__componentOriginal9f64f32e90b9102968f2bc548315018c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal9f64f32e90b9102968f2bc548315018c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modal','data' => ['id' => 'modalEditData','title' => 'Edit Data Undangan','description' => 'Perbarui jumlah undangan untuk periode ini.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('modal'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'modalEditData','title' => 'Edit Data Undangan','description' => 'Perbarui jumlah undangan untuk periode ini.']); ?>
        <form action="<?php echo e(route('undangan.store')); ?>" method="POST" id="formEdit" class="space-y-5 novalidate-form" novalidate>
            <?php echo csrf_field(); ?>
            ...
            <?php if(isset($kolomDinamis) && $kolomDinamis->count() > 0): ?>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <?php $__currentLoopData = $kolomDinamis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kolom): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="md:col-span-2">
                            <label class="block text-xs font-medium text-gray-700 mb-1"><?php echo e($kolom->nama_kolom); ?></label>
                            <?php if($kolom->tipe_input === 'text'): ?><input type="text" name="data_tambahan[<?php echo e($kolom->nama_kolom); ?>]" data-key="<?php echo e($kolom->nama_kolom); ?>" class="input-dinamis-edit w-full px-3 py-2 border border-gray-300 rounded-lg text-sm outline-none">
                            <?php elseif($kolom->tipe_input === 'number'): ?><input type="number" name="data_tambahan[<?php echo e($kolom->nama_kolom); ?>]" data-key="<?php echo e($kolom->nama_kolom); ?>" class="input-dinamis-edit w-full px-3 py-2 border border-gray-300 rounded-lg text-sm outline-none">
                            <?php elseif($kolom->tipe_input === 'currency'): ?>
                                <div class="relative"><div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-gray-500">Rp</div><input type="text" name="data_tambahan[<?php echo e($kolom->nama_kolom); ?>]" data-key="<?php echo e($kolom->nama_kolom); ?>" class="input-currency input-dinamis-edit w-full pl-9 pr-4 py-2 border border-gray-300 rounded-lg text-sm font-mono outline-none" placeholder="0"><input type="hidden" name="data_tambahan[<?php echo e($kolom->nama_kolom); ?>]"></div>
                            <?php elseif($kolom->tipe_input === 'date'): ?><input type="date" name="data_tambahan[<?php echo e($kolom->nama_kolom); ?>]" data-key="<?php echo e($kolom->nama_kolom); ?>" class="input-dinamis-edit w-full px-3 py-2 border border-gray-300 rounded-lg text-sm outline-none">
                            <?php elseif($kolom->tipe_input === 'dropdown'): ?>
                                <select name="data_tambahan[<?php echo e($kolom->nama_kolom); ?>]" data-key="<?php echo e($kolom->nama_kolom); ?>" class="input-dinamis-edit w-full px-3 py-2 border border-gray-300 rounded-lg text-sm outline-none">
                                    <option value="">Pilih...</option>
                                    <?php if($kolom->pilihan_dropdown): ?> <?php $__currentLoopData = json_decode($kolom->pilihan_dropdown); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pilihan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><option value="<?php echo e(trim($pilihan)); ?>"><?php echo e(trim($pilihan)); ?></option><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> <?php endif; ?>
                                </select>
                            <?php endif; ?>
         ...
         <?php $__env->slot('footer', null, []); ?> 
            <?php if (isset($component)) { $__componentOriginald0f1fd2689e4bb7060122a5b91fe8561 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald0f1fd2689e4bb7060122a5b91fe8561 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.button','data' => ['variant' => 'outline','onclick' => 'closeModal(\'modalEditData\')','class' => '!px-6 !py-2.5 !rounded-lg']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'outline','onclick' => 'closeModal(\'modalEditData\')','class' => '!px-6 !py-2.5 !rounded-lg']); ?>Batal <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginald0f1fd2689e4bb7060122a5b91fe8561)): ?>
<?php $attributes = $__attributesOriginald0f1fd2689e4bb7060122a5b91fe8561; ?>
<?php unset($__attributesOriginald0f1fd2689e4bb7060122a5b91fe8561); ?>
...
<?php endif; ?>
            <?php if (isset($component)) { $__componentOriginald0f1fd2689e4bb7060122a5b91fe8561 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald0f1fd2689e4bb7060122a5b91fe8561 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.button','data' => ['variant' => 'primary','type' => 'submit','form' => 'formEdit','class' => '!px-6 !py-2.5 !rounded-lg !bg-amber-500 hover:!bg-amber-600 border-none']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'primary','type' => 'submit','form' => 'formEdit','class' => '!px-6 !py-2.5 !rounded-lg !bg-amber-500 hover:!bg-amber-600 border-none']); ?>Update Data <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginald0f1fd2689e4bb7060122a5b91fe8561)): ?>
<?php $attributes = $__attributesOriginald0f1fd2689e4bb7060122a5b91fe8561; ?>
<?php unset($__attributesOriginald0f1fd2689e4bb7060122a5b91fe8561); ?>
...
<?php endif; ?>
    ...
    <?php if (isset($component)) { $__componentOriginal9f64f32e90b9102968f2bc548315018c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal9f64f32e90b9102968f2bc548315018c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modal','data' => ['id' => 'modalTambahDetail','title' => 'Tambah Rincian Undangan']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('modal'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'modalTambahDetail','title' => 'Tambah Rincian Undangan']); ?>
        <form action="<?php echo e(route('undangan.detail.store')); ?>" method="POST" class="space-y-4">
            <?php echo csrf_field(); ?>
            <div class="grid grid-cols-2 gap-4">
                <div>
                ...
                <div>
                    ...
                    <select name="bulan" required class="w-full px-4 py-2 border border-gray-200 rounded-xl bg-white text-sm text-gray-700 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 transition-colors">
                        ...
                        <?php $__currentLoopData = ['Januari','Februari','Maret','April','Mei','Juni','Juli','Agustus','September','Oktober','November','Desember']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?>
    ...
    <?php if (isset($component)) { $__componentOriginal9f64f32e90b9102968f2bc548315018c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal9f64f32e90b9102968f2bc548315018c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modal','data' => ['id' => 'modalEditDetail','title' => 'Edit Rincian Undangan']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('modal'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'modalEditDetail','title' => 'Edit Rincian Undangan']); ?>
...
<?php endif; ?>
    ...
    <?php if($errors->has('nama_kolom') || $errors->has('tipe_input')): ?>
