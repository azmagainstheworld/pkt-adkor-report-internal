...
$content = str_replace($searchRawData, $replaceRawData, $content);

// Also we need to pass $dataTerbit and $dataProses to the view
$searchCompact = "return view('bar-sk-memo', compact(
            'tanggalToday', 'filterTahun', 'filterBulan', 'tahunTersedia', 
            'rawData', 'grandTotalTerbit', 'grandTotalProses',
            'kolomTerbit', 'kolomProses'
        ));";
$replaceCompact = "return view('bar-sk-memo', compact(
            'tanggalToday', 'filterTahun', 'filterBulan', 'tahunTersedia', 
            'rawData', 'dataTerbit', 'dataProses', 'grandTotalTerbit', 'grandTotalProses',
            'kolomTerbit', 'kolomProses'
        ));";
$content = str_replace($searchCompact, $replaceCompact, $content);

file_put_contents($file, $content);
echo "Controller pagination refactored\n";
