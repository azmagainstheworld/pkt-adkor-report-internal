...
// 1. Update KaryawanController.php
...
// 2. Rewrite resources/views/pdf/karyawan.blade.php
$pdfBlade = <<<'EOT'
<!DOCTYPE html>
<html>
<head>
...
file_put_contents('resources/views/pdf/karyawan.blade.php', $pdfBlade);

echo "PDF view and controller updated for 'lengkap'.\n";
